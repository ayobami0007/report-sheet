// // src/components/primary/PreviewLayout.jsx
// //
// // Objective printed format:
// //   1. question text __________
// //      A. opt   B. opt   C. opt   D. opt
// //
// // Theory printed format:
...
//                 </tr>
//                  <tr>
//                   <td style={{ padding: "2px 0" }}><strong>Name:</strong>____________________</td>
//                   <td style={{ padding: "2px 0" }}><strong>Score:</strong> ____________________</td>
//                 </tr>
//               </tbody>
//             </table>
...
//                   // Question: "1. text __________" then "A. opt  B. opt  C. opt  D. opt"
//                   qNum++;
//                   return (
...
//                           </div>
//                           <div style={{ paddingLeft: "18px", fontSize: "12.5px" }}>
...
//                           <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: "10px", marginBottom: "3px" }}>
//                             <span style={{ flex: 1 }}>
//                               <strong>{idx + 1}.</strong>&nbsp;{q.text || `[Question ${idx + 1}]`}
//                             </span>
//                             {q.marks && <span style={{ fontSize: "11.5px", color: "#555", whiteSpace: "nowrap", fontStyle: "italic" }}>({q.marks} marks)</span>}
//                           </div>
